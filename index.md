...
title: Home
nav_order: 1
description: "Repositorio documental del módulo Despliegue de Aplicaciones Web (DAW)"
permalink: /
has_children: true
---
...
![Just the Docs Badge](https://img.shields.io/badge/theme-just--the--docs-blue)
![License](https://img.shields.io/badge/license-GPL--3.0-green)

Bienvenido al repositorio documental del módulo **Despliegue de Aplicaciones Web** del CFGS en Desarrollo de Aplicaciones Web.
...
- **Organización clara**: Estructura modular con carpeta para cada unidad
- **Navegación intuitiva**: Menú lateral con acceso rápido a contenidos
- **Búsqueda integrada**: Funcionalidad de búsqueda en todos los documentos
- **Markdown documentado**: Archivos en formato markdown fáciles de editar
...
1. **Navegación**: Use el menú lateral para acceder a cada unidad temática
2. **Búsqueda**: Use la barra de búsqueda para encontrar contenidos específicos
3. **Enlace compartido**: Comparta este repositorio con compañeros y profesores
4. **Contribuciones**: Los miembros del grupo pueden contribuir con commits

## 🔗 Enlaces Importantes

- [Repositorio en GitHub](https://github.com/)
- [CFGS - Desarrollo de Aplicaciones Web](https://www.iespsur.es/)
